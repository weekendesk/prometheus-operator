...
func GetGeneratedDeepCopyFuncs() []conversion.GeneratedDeepCopyFunc {
	return []conversion.GeneratedDeepCopyFunc{
		...
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			...
			return nil
		}, InType: reflect.TypeOf(&PrometheusRule{})},
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*PrometheusRuleList).DeepCopyInto(out.(*PrometheusRuleList))
			return nil
		}, InType: reflect.TypeOf(&PrometheusRuleList{})},
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*PrometheusRuleSpec).DeepCopyInto(out.(*PrometheusRuleSpec))
			return nil
		}, InType: reflect.TypeOf(&PrometheusRuleSpec{})},
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
		...
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*QuerySpec).DeepCopyInto(out.(*QuerySpec))
			return nil
		}, InType: reflect.TypeOf(&QuerySpec{})},
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*QueueConfig).DeepCopyInto(out.(*QueueConfig))
			return nil
		}, InType: reflect.TypeOf(&QueueConfig{})},
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
		...
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*RuleGroup).DeepCopyInto(out.(*RuleGroup))
			return nil
		}, InType: reflect.TypeOf(&RuleGroup{})},
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
		...
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*ThanosGCSSpec).DeepCopyInto(out.(*ThanosGCSSpec))
			return nil
		}, InType: reflect.TypeOf(&ThanosGCSSpec{})},
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*ThanosS3Spec).DeepCopyInto(out.(*ThanosS3Spec))
			return nil
		}, InType: reflect.TypeOf(&ThanosS3Spec{})},
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*ThanosSpec).DeepCopyInto(out.(*ThanosSpec))
			return nil
		}, InType: reflect.TypeOf(&ThanosSpec{})},
	}
}
...
func (in *AlertmanagerSpec) DeepCopyInto(out *AlertmanagerSpec) {
	*out = *in
	...
	if in.ImagePullSecrets != nil {
		...
		*out = make([]api_v1.LocalObjectReference, len(*in))
		copy(*out, *in)
	}
	if in.Secrets != nil {
	...
	if in.SecurityContext != nil {
		...
		if *in == nil {
			...
			*out = new(api_v1.PodSecurityContext)
			(*in).DeepCopyInto(*out)
		}
	}
	if in.Containers != nil {
		in, out := &in.Containers, &out.Containers
		*out = make([]api_v1.Container, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	*out = *in
	...
	if in.AdditionalScrapeConfigs != nil {
		...
		if *in == nil {
			...
			*out = new(api_v1.SecretKeySelector)
			(*in).DeepCopyInto(*out)
		}
	}
	...
	*out = *in
	if in.EmptyDir != nil {
		...
		if *in == nil {
			...
			*out = new(api_v1.EmptyDirVolumeSource)
			**out = **in
		}
	}
