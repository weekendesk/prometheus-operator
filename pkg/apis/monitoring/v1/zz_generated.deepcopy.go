...
func (in *AlertmanagerSpec) DeepCopyInto(out *AlertmanagerSpec) {
	*out = *in
	...
	if in.ImagePullSecrets != nil {
		...
		*out = make([]apiv1.LocalObjectReference, len(*in))
		copy(*out, *in)
	}
	if in.Secrets != nil {
	...
	if in.Affinity != nil {
		...
		*out = new(apiv1.Affinity)
		(*in).DeepCopyInto(*out)
	}
	if in.Tolerations != nil {
		in, out := &in.Tolerations, &out.Tolerations
		*out = make([]apiv1.Toleration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SecurityContext != nil {
		...
		*out = new(apiv1.PodSecurityContext)
		(*in).DeepCopyInto(*out)
	}
	if in.Containers != nil {
		in, out := &in.Containers, &out.Containers
		*out = make([]apiv1.Container, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PrometheusSpec) DeepCopyInto(out *PrometheusSpec) {
	*out = *in
	...
	if in.AdditionalScrapeConfigs != nil {
		...
		*out = new(apiv1.SecretKeySelector)
		(*in).DeepCopyInto(*out)
	}
...
func (in *StorageSpec) DeepCopyInto(out *StorageSpec) {
	*out = *in
	if in.EmptyDir != nil {
		...
		*out = new(apiv1.EmptyDirVolumeSource)
		**out = **in
	}
